                        ...
                        <select class="form-control" id="schedule" name="schedule" required>
                            ...
                            @foreach ($schedules as $schedule)
                                <option value="{{ $schedule->slug }}"
                                    @if(isset($employee->schedules->first()->slug) && $employee->schedules->first()->slug == $schedule->slug) selected @endif>
                                    {{ $schedule->slug }} -> from {{ date('h:i A', strtotime($schedule->time_in)) }} to {{ date('h:i A', strtotime($schedule->time_out)) }}
                                </option>
                            @endforeach
                        </select>
                    </div>

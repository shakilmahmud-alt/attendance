                                ...
                                <tbody>
                                    ...
                                    @foreach ($attendances as $attendance)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ date('h:i A', strtotime($attendance->attendance_time)) }}
                                            ...
                                            <td>{{ isset($attendance->employee->schedules->first()->time_in) ? date('h:i A', strtotime($attendance->employee->schedules->first()->time_in)) : 'N/A' }} </td>
                                            <td>{{ isset($attendance->employee->schedules->first()->time_out) ? date('h:i A', strtotime($attendance->employee->schedules->first()->time_out)) : 'N/A' }}</td>
                                        </tr>

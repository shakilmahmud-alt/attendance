                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('h:i A', strtotime($leave->leave_time)) }}
                                        @if( $leave->status == 1 )
                                    ...
                                    <td>{{ isset($leave->employee->schedules->first()->time_in) ? date('h:i A', strtotime($leave->employee->schedules->first()->time_in)) : 'N/A' }} </td>
                                    <td>{{ isset($leave->employee->schedules->first()->time_out) ? date('h:i A', strtotime($leave->employee->schedules->first()->time_out)) : 'N/A' }}</td>
                                </tr>

                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($latetime->employee->schedules->first()->time_in) ? date('h:i A', strtotime($latetime->employee->schedules->first()->time_in)) : 'N/A' }} </td>
                                    <td>{{ isset($latetime->employee->schedules->first()->time_out) ? date('h:i A', strtotime($latetime->employee->schedules->first()->time_out)) : 'N/A' }}</td>
                                </tr>

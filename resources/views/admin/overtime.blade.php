                                ...
                                <tbody>
                                    @foreach ($overtimes as $overtime)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ isset($overtime->employee->schedules->first()->time_in) ? date('h:i A', strtotime($overtime->employee->schedules->first()->time_in)) : 'N/A' }} </td>
                                            <td>{{ isset($overtime->employee->schedules->first()->time_out) ? date('h:i A', strtotime($overtime->employee->schedules->first()->time_out)) : 'N/A' }}</td>
                                        </tr>
